...
func (u *userService) GetForToken(ctx context.Context, tokenScope, tokenPlaintext string) (*service_models.User, error) {
	return u.userRepo.GetForToken(ctx, tokenScope, tokenPlaintext)
}
